...
box.css、color.css、common.css 是消化了 [universal.css](https://github.com/marmelab/universal.css)、[open-color.css](https://github.com/yeun/open-color)、[tachyons.css](https://github.com/tachyons-css/tachyons) 而来的。命名都采用了 [Emmet](http://emmet.io/) 中的规范。
