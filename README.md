...
box.css、color.css、common.css 中的命名都采用 [Emmet](http://emmet.io/) 的规范，消化 [universal.css](https://github.com/marmelab/universal.css)、[open-color.css](https://github.com/yeun/open-color)、[tachyons.css](https://github.com/tachyons-css/tachyons) 而来。
